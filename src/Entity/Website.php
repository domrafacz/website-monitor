...
class Website
{
    ...
    #[ORM\OneToMany(mappedBy: 'website', targetEntity: ResponseLog::class, cascade: ['persist'], fetch: 'EXTRA_LAZY', orphanRemoval: true)]
    ...
    #[ORM\OneToMany(mappedBy: 'website', targetEntity: DowntimeLog::class, cascade: ['persist'], fetch: 'EXTRA_LAZY', orphanRemoval: true)]
